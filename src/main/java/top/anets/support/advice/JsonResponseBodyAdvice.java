...
public class JsonResponseBodyAdvice implements ResponseBodyAdvice<Object> {
    ...
    public Object beforeBodyWrite(Object o, MethodParameter methodParameter, MediaType mediaType,
        ...
        Annotation[] declaredAnnotations = methodParameter.getMethod().getDeclaredAnnotations();
        if(methodParameter.getDeclaringClass().isAnnotationPresent(Response.class)){
            return o;
        }
